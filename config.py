...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+Agu-udtgKRk2ZjFl")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/8newbf.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/8newbf.jpg"
)
